...
2. Commission Split
Every completed job automatically triggers a payment capture and a  transfer. Washly keeps 15% of the job price, and the washer receives 85% directly into their connected  account — no manual payouts needed.
3. Rating & Feedback
